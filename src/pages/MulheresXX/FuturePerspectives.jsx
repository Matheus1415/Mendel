        ...
        >
          <Box>
            ...
            <Text variant="Paragraph" textAlign="justify">
              O futuro das mulheres na genética está cheio de transformações e oportunidades, com o avanço de tecnologias como a edição de genes e a genômica personalizada. A maior presença feminina em papéis de liderança e pesquisa está enriquecendo a ciência e diversificando abordagens, resultando em avanços significativos, como a medicina personalizada e um melhor entendimento de condições genéticas.
            </Text>
            <Text variant="Paragraph" textAlign="justify">
              O futuro das mulheres na genética promete mais equidade de gênero, com políticas e iniciativas promovendo igualdade de oportunidades. Esse ambiente mais inclusivo e colaborativo, com mulheres em posições de destaque, deve impulsionar inovação e uma abordagem mais holística para os desafios genéticos, evidenciando o impacto positivo da diversidade de gênero nas ciências.
            </Text>
          </Box>
