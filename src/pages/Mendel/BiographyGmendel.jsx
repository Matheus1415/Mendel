...
export function BiographyGmendel() {
  ...
  return (
    <MotionFlex align="center" direction="column" w="100%" height="100%"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 1 }}
    >
      <MotionFlex align="center" direction={flexDirection} padding="24px 24px" margin="0 auto"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, delay: 0.5 }}
      >
        <MotionBox marginTop={marginTitle}
        ...
        >
          ...
          <Text fontSize={textSize} w={[300, 450, 550, 700, 600]} textAlign="justify" fontWeight="275" color="#EBEBEB" marginTop="20px" marginBottom="10px">
          ...
          <Text fontSize={textSize} w={[300, 450, 550, 700, 600]} textAlign="justify" fontWeight="275" color="#EBEBEB" marginBottom="10px">
