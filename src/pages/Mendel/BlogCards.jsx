...
export function BlogCards({title, description, link, indexTransition}) {
  ...
  return(
    <Box>
        <Card w={['300px', '523px']} h={['147px', '127px']} backgroundColor='#0D6067' borderRadius='15px' transform={`translateX(-${indexTransition}px) `} transition='transform 0.8s ease-in-out'>
            ...
            <Divider w={['300px', '479px']} h='1px' color='#E6E6E6' margin='0 auto'/>
