import { Card, CardHeader, CardBody, CardFooter, Heading, Text, Button, Flex, Box, background } from '@chakra-ui/react'

export function VideoCard ({title, author, description, img}) {
    return(
        <Card w={80} borderRadius='lg' bgColor="#0D6067">
            ...
            <CardFooter borderBottomRadius='lg' justifyContent="end" pt={2}>
                ...
                <Button _hover={{bgColor:'transparent'}} borderRadius={100} color="white" bgColor='transparent' borderWidth={1} fontWeight={300} px={8} py={21} textTransform='capitalize'>assista</Button>
