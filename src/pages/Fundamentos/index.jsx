...
<Box as='section' mb='10rem'>
    ...
    >
        ...
        >
            ...
            <Tooltip label='placeholder1' hasArrow placement='right' w='fit-content'>
                <Box
                  bg='red.500'
                  opacity='0.4'
                  h='13.7%'
            ...
            <Tooltip label='placeholder2' hasArrow placement='right' w='fit-content'>
                <Box
                  bg='red.500'
                  opacity='0.4'
                  h='14%'
            ...
            <Tooltip label='placeholder3' hasArrow placement='right' w='fit-content'>
                <Box
                  bg='red.500'
                  opacity='0.4'
                  h='15.7%'
            ...
            <Tooltip label='placeholder4' hasArrow placement='right' w='fit-content'>
                <Box
                  bg='red.500'
                  opacity='0.4'
                  h='16%'
