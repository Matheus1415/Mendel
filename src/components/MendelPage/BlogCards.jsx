import { Box, Button, Card, CardHeader, CardBody, Divider, Text} from "@chakra-ui/react"
export function BlogCards({title, description}) {
    ...
    <Box>
        <Card w='523px' h='127px' backgroundColor='#0D6067' borderRadius='15px'>
            <CardHeader display='flex' flexDirection='row' justifyContent='space-between' alignItems='center'>           
                ...
                <Button w='92px' h='30px' border='1px solid #EBEBEB' colorScheme='#0D6067' fontSize='12px' fontWeight='275' borderRadius='100px'>Leia mais</Button>
            </CardHeader>
